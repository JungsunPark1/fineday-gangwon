...
export const fetchDustData = async () => {
  const URL =
    'http://apis.data.go.kr/B552584/ArpltnInforInqireSvc/getCtprvnRltmMesureDnsty?serviceKey=Yr6jP9pcxIeobwpMRKwBXBuNVz1pZ3BX3hTp5d7cTL08bO%2F3fudgUVk82zJdmAJ9xFzEmgnlXXLM%2FcGWJgLjtA%3D%3D';
  try {
...
export const fetchWeatherData = async (nx, ny, specialDate, specialTime) => {
  const URL =
    'http://apis.data.go.kr/1360000/VilageFcstInfoService_2.0/getVilageFcst?serviceKey=Yr6jP9pcxIeobwpMRKwBXBuNVz1pZ3BX3hTp5d7cTL08bO%2F3fudgUVk82zJdmAJ9xFzEmgnlXXLM%2FcGWJgLjtA%3D%3D';
  try {
